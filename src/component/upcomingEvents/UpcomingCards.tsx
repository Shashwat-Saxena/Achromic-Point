...
const events: Event[] = [
 {
    ...
    location: "Dubai, UAE",
    image: image1,
    description: "Understand the latest UAE tax policies and compliance regulations with key regional experts.",
  },
  {
    ...
    image: image2,
    description: "Network with legal leaders and explore modern challenges in the legal industry.",
  },
  {
    ...
    location: "Virtual",
    image: image3,
    description: "Master global transfer pricing practices and regulatory frameworks in a live online format.",
  },
  {
    ...
    image: image4,
    description: "Dive deep into GST implementation challenges and real-world application examples.",
  },
  {
    ...
    location: "Online",
    image: image5,
    description: "Earn your certification in international tax and elevate your global tax knowledge.",
  },
  {
    ...
    location: "Dubai, UAE",
    image: image6,
    description: "Top minds in law gather to discuss cross-border compliance, ethics, and innovation.",
  },
  {
    ...
    image: image7,
    description: "Gain hands-on understanding of GST reforms with actionable case studies and expert talks.",
  },
  {
    ...
    location: "New Delhi, India",
    image: image8,
    description: "Explore the future of IP law, patents, trademarks, and legal enforcement strategies.",
  },
  {
    ...
    location: "Mumbai, India",
    image: image9,
    description: "Decode GST complexities and compliance strategies for the financial capital of India.",
  },
  {
    ...
    location: "Pune, India",
    image: image10,
    description: "Strategic leadership, financial forecasting, and networking for the CFO elite.",
  },
];
